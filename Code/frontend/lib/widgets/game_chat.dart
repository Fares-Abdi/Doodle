...
class _GameChatState extends State<GameChat> with AudioMixin, WidgetsBindingObserver {
  ...
  void initState() {
    ...
    // Add lifecycle observer to track keyboard
  ...
  void didChangeMetrics() {
    ...
    // Detect keyboard state change - no focus check needed
    if (currentViewInsetBottom > 0 && _lastViewInsetBottom == 0) {
      // Keyboard appeared
      widget.onInputFocused?.call();
    } else if (currentViewInsetBottom == 0 && _lastViewInsetBottom > 0) {
      // Keyboard disappeared
      widget.onInputUnfocused?.call();
    }
    
    _lastViewInsetBottom = currentViewInsetBottom;
  }
              ...
              child: Container(
                ...
                child: Focus(
                  onFocusChange: (hasFocus) {
                    ...
                    // Backup callback in case didChangeMetrics doesn't work
                    // This ensures we catch focus changes too
                  },
                  child: TextField(
