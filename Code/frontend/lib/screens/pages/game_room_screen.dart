...
class _GameRoomScreenState extends State<GameRoomScreen> with TickerProviderStateMixin, AudioMixin, WidgetsBindingObserver {
  ...
  void _handleMessageSend(String message) {
    ...
    // Get current player for photoURL
    final currentPlayer = _currentGameSession.players
        .firstWhere((p) => p.id == widget.userId, orElse: () => Player(id: '', name: widget.userName, isDrawing: false));
